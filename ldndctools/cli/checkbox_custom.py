...
"""This is a small patched version of the questionary checkbox function

NOTE:
    - try to push upstream
    - check if this can be achieved with less code duplication
"""
...
def checkbox(
    ...
    **kwargs: Any,
    ...
    def go_back(event):
        ic.is_answered = True
        event.app.exit(result=["BACK"] + [c.value for c in ic.get_selected_values()])
